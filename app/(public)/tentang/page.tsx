...
const nilaiOrganisasi = [
  {
    ...
    emoji: '🤝',
    judul: 'Kebersamaan',
    deskripsi: 'Kami percaya bahwa kekuatan sejati lahir dari kebersamaan. Setiap anggota adalah bagian dari keluarga besar yang saling mendukung, menguatkan, dan tumbuh bersama.',
  },
  {
    icon: Heart,
    emoji: '❤️',
    judul: 'Kepedulian Sosial',
    deskripsi: 'Kami hadir di saat anggota maupun warga masyarakat membutuhkan—baik ketika sakit, mengalami musibah, maupun dalam momen kebahagiaan. Bagi kami, peduli bukan pilihan, melainkan kewajiban.',
  },
  {
    icon: Building2,
    emoji: '🕌',
    judul: 'Religiusitas',
    deskripsi: 'Nilai-nilai keagamaan menjadi fondasi setiap langkah PPDT. Melalui pengajian, perawatan musholla, dan santunan kepada yatim piatu serta kaum duafa, kami berupaya menjaga keseimbangan antara hidup duniawi dan ukhrawi.',
  },
  {
    icon: Vote,
    emoji: '🗳️',
    judul: 'Musyawarah & Demokrasi',
    deskripsi: 'Setiap suara berharga. Kami menjunjung tinggi musyawarah dan voting sebagai cara mengambil keputusan, memastikan setiap anggota memiliki ruang untuk berpendapat dan berkontribusi.',
  },
  {
    icon: ShieldCheck,
    emoji: '🌟',
    judul: 'Tanggung Jawab & Disiplin',
    deskripsi: 'Mulai dari kewajiban iuran arisan dan kas, hingga ketertiban dalam setiap pertemuan, kami menanamkan nilai disiplin dan tanggung jawab sebagai cerminan komitmen kepada organisasi.',
  },
  {
    icon: Home,
    emoji: '🏘️',
    judul: 'Cinta Lingkungan & Persaudaraan',
    deskripsi: 'Kami mencintai kampung halaman dan menjadikan persaudaraan sebagai ikatan abadi—tidak hanya bagi yang menetap di Dukuh Tengah, tetapi juga bagi saudara-saudara kami di perantauan.',
  },
]
    ...
    <>
      ...
      <section className="relative bg-mesh-sunset py-20 md:py-28 -mt-16 md:-mt-20 pt-32 md:pt-40 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="max-w-3xl mx-auto space-y-5">
            <Card className="border-0 shadow-xl shadow-orange-500/10 overflow-hidden bg-white/95 backdrop-blur-sm">
              <CardContent className="p-7 md:p-9 relative">
                ...
                <p className="text-stone-700 leading-relaxed text-base md:text-lg mb-4">
                  <span className="font-display font-bold text-orange-600">Persatuan Pemuda Dukuh Tengah (PPDT)</span> adalah wadah perkumpulan pemuda yang lahir dari semangat kebersamaan dan rasa kepedulian terhadap lingkungan masyarakat di wilayah Dukuh Tengah, khususnya <span className="font-semibold">RT 12, 13, dan 14</span> Desa Tamansari, Kec. Jatinegara - Kab. Tegal.
                </p>
                <p className="text-stone-700 leading-relaxed text-base md:text-lg mb-4">
                  Berlandaskan moto <em className="text-orange-600 font-semibold">&ldquo;Membangun Kebersamaan, Menjalin Persaudaraan&rdquo;</em>, PPDT hadir sebagai rumah bagi para pemuda untuk bersatu, berkarya, dan memberikan kontribusi nyata bagi kampung halaman.
                </p>
                <p className="text-stone-700 leading-relaxed text-base md:text-lg">
                  Lebih dari sekadar organisasi, PPDT adalah <span className="font-semibold text-stone-900">keluarga besar</span> yang menjunjung tinggi nilai gotong royong, solidaritas, dan kepedulian sosial. Melalui berbagai kegiatan rutin seperti arisan bulanan, pengajian, peringatan hari kemerdekaan, kegiatan olahraga, hingga program sosial bagi anak yatim dan kaum duafa, PPDT terus berupaya merawat tradisi, mempererat tali persaudaraan, dan membangun masyarakat yang harmonis.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="container mx-auto px-4 py-16 md:py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="border-0 shadow-2xl shadow-orange-500/15 overflow-hidden bg-white relative">
            ...
            <CardContent className="p-8 md:p-12 relative text-center">
              ...
              <p className="text-xl md:text-2xl text-stone-800 leading-relaxed font-display font-medium italic">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-stone-600 mt-3 text-lg">Enam komitmen untuk mewujudkan visi PPDT</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {misiList.map((misi, idx) => (
                <Card
                  key={idx}
                  className="group border-0 bg-white hover:shadow-2xl hover:shadow-orange-500/20 transition-all duration-300 hover:-translate-y-1 overflow-hidden"
                >
                  <CardContent className="p-6 relative">
                    <div className="flex items-start gap-4">
                      ...
                      <p className="text-stone-700 leading-relaxed text-sm md:text-base flex-1">
                        {misi}
                      </p>
                    </div>
                  </CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 max-w-6xl mx-auto">
          {nilaiOrganisasi.map((nilai, idx) => {
            ...
            return (
              <Card
                key={nilai.judul}
                className="group hover:shadow-2xl hover:shadow-orange-500/20 transition-all duration-300 hover:-translate-y-2 border-0 bg-white overflow-hidden relative"
              >
                ...
                <CardContent className="p-7 relative">
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <h3 className="font-display font-bold text-lg text-stone-900 leading-tight">{nilai.judul}</h3>
                    </div>
                  </div>
