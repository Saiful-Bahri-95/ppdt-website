...
import { dummyKeuangan, hitungSaldoTotal, hitungRekapBulanan } from '@/lib/dummy-data'
import { formatRupiah, formatTanggal, formatPeriode } from '@/lib/format'

export default function KeuanganPage() {
  const saldoTotal = hitungSaldoTotal(dummyKeuangan)
  const rekapBulanan = hitungRekapBulanan(dummyKeuangan)
  const totalPemasukan = dummyKeuangan
    .filter((t) => t.jenis === 'pemasukan')
    .reduce((acc, t) => acc + t.nominal, 0)
  const totalPengeluaran = dummyKeuangan
    .filter((t) => t.jenis === 'pengeluaran')
    .reduce((acc, t) => acc + t.nominal, 0)

  // Transaksi terbaru (top 10)
  const transaksiTerbaru = [...dummyKeuangan]
            ...
            <CardContent className="p-8 md:p-10 relative">
              ...
              <div className="relative flex flex-col md:flex-row items-center justify-between gap-6">
                <div>
                  ...
                  <p className="text-4xl md:text-6xl font-display font-extrabold leading-none mb-2">
                    {formatRupiah(saldoTotal)}
                  </p>
                  <p className="text-sm text-orange-100">Per April 2026</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xl md:text-2xl font-display font-extrabold text-green-600">
      ...
      <section className="container mx-auto px-4 py-12 bg-orange-50/50 -mx-4 md:mx-0 md:rounded-3xl">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl md:text-4xl font-display font-extrabold text-stone-900">
              <span className="text-gradient-sunset">10 Transaksi</span> Terakhir
            </h2>
          </div>
