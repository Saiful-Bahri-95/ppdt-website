    ...
    <>
      <section className="relative bg-mesh-sunset py-16 md:py-20 -mt-16 md:-mt-20 pt-28 md:pt-32 overflow-hidden">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-10 right-20 w-72 h-72 bg-amber-400 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-3xl opacity-20 animate-blob" />
        </div>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-white/70 dark:bg-stone-900/70 backdrop-blur-md border border-orange-200 dark:border-orange-900/50 rounded-full px-4 py-1.5 mb-6 shadow-sm">
              ...
              <span className="text-xs font-semibold text-stone-700 dark:text-stone-300">Laporan Keuangan</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-display font-extrabold mb-4 leading-tight">
              ...
              <br />
              <span className="text-stone-900 dark:text-stone-50">Keuangan Kami</span>
            </h1>
      ...
      <section className="container mx-auto px-4 py-4">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card className="border-0 bg-white dark:bg-stone-900 shadow-lg shadow-green-500/10">
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs text-stone-500 dark:text-stone-400 font-medium uppercase">Total Pemasukan</p>
                  <p className="text-xl md:text-2xl font-display font-extrabold text-green-600 dark:text-green-400">{formatRupiah(totalPemasukan)}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          <Card className="border-0 bg-white dark:bg-stone-900 shadow-lg shadow-red-500/10">
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs text-stone-500 dark:text-stone-400 font-medium uppercase">Total Pengeluaran</p>
                  <p className="text-xl md:text-2xl font-display font-extrabold text-red-600 dark:text-red-400">{formatRupiah(totalPengeluaran)}</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <section className="container mx-auto px-4 py-12">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-stone-600 dark:text-stone-400 mt-2">Pantau perkembangan keuangan dalam grafik interaktif</p>
            </div>

            <div className="mb-6">
              <SaldoTrendChart transaksi={transaksi} description="Perkembangan saldo kas dari bulan ke bulan" />
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <PemasukanPengeluaranChart transaksi={transaksi} description="Perbandingan arus kas per bulan" />
              <KategoriPengeluaranChart transaksi={transaksi} description="Distribusi pengeluaran berdasarkan kategori" />
            </div>
          </div>
        </section>
      )}
      ...
      {rekapBulanan.length > 0 && (
        <section className="container mx-auto px-4 py-12 bg-orange-50/50 dark:bg-orange-950/20 -mx-4 md:mx-0 md:rounded-3xl">
          <div className="max-w-4xl mx-auto px-4">
            <div className="text-center mb-8">
              <Badge className="mb-3 bg-orange-100 dark:bg-orange-950/50 text-orange-700 dark:text-orange-400 hover:bg-orange-100 border-0 px-3 py-1 text-xs font-semibold">📊 Rekap Bulanan</Badge>
              <h2 className="text-3xl md:text-4xl font-display font-extrabold text-stone-900 dark:text-stone-50">
            ...
            <div className="space-y-3">
              {rekapBulanan.map((rekap) => (
                <Card key={`${rekap.tahun}-${rekap.bulan}`} className="border-0 bg-white dark:bg-stone-900 hover:shadow-xl hover:shadow-orange-500/10 transition-all overflow-hidden">
                  <CardContent className="p-5 md:p-6">
                    <div className="flex items-center justify-between gap-4 flex-wrap">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="font-display font-bold text-base md:text-lg text-stone-900 dark:text-stone-50">
                            {formatPeriode(rekap.bulan, rekap.tahun)}
                          </h3>
                          <p className="text-xs text-stone-500 dark:text-stone-400">Saldo periode</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-4 md:gap-6 text-right ml-auto">
                        <div className="hidden sm:block">
                          ...
                          <p className="font-semibold text-green-600 dark:text-green-400 text-sm">{formatRupiah(rekap.total_pemasukan)}</p>
                        </div>
                        <div className="hidden sm:block">
                          <p className="text-xs text-stone-500 dark:text-stone-400">Keluar</p>
                          <p className="font-semibold text-red-600 dark:text-red-400 text-sm">{formatRupiah(rekap.total_pengeluaran)}</p>
                        </div>
                        <div>
                          <p className="text-xs text-stone-500 dark:text-stone-400">Saldo</p>
                          <p className={`font-display font-extrabold text-base md:text-lg ${rekap.saldo_periode >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
      ...
      {transaksiTerbaru.length > 0 && (
        <section className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <Badge className="mb-3 bg-orange-100 dark:bg-orange-950/50 text-orange-700 dark:text-orange-400 hover:bg-orange-100 border-0 px-3 py-1 text-xs font-semibold">💸 Transaksi Terbaru</Badge>
              <h2 className="text-3xl md:text-4xl font-display font-extrabold text-stone-900 dark:text-stone-50">
            ...
            <div className="space-y-2">
              {transaksiTerbaru.map((t) => (
                <Card key={t.id} className="border-0 bg-white dark:bg-stone-900 hover:shadow-md transition-all overflow-hidden">
                    ...
                    <div className="flex items-center justify-between gap-3">
                      <div className="flex items-center gap-3 min-w-0 flex-1">
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="font-semibold text-sm text-stone-900 dark:text-stone-50 truncate">{t.keterangan || t.kategori}</p>
                      ...
                      <p className={`font-display font-bold text-sm md:text-base whitespace-nowrap ${
                        t.jenis === 'pemasukan' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'
                      }`}>
